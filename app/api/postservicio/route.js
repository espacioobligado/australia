...
export async function POST(request) {
    ...
    const postServicio = async (data) => {
        try {
            ...
            // if(price === 'marketPrice') price = 'market price'
            const id = data.id
            let userId;
            ...
            const query = 'INSERT INTO public.servicios(id,region, usuario, bienoservicio, zone, price, timePosteo) VALUES ($1, $2, $3, $4, $5, $6, $7)';
